...
const Compras = () => {
  ...
  const handleProductSelect = (product) => {
    setSelectedProduct(product.Productoid);
  ...
  return (
    <div>
      ...
      <Button sx={{ mb: 2, mt: 2 }} variant="outlined" color="primary" onClick={handleOpenCompraDialog}>
        Agregar Compra
      </Button>
            ...
            {compras.length > 0 ? (
              compras.map((compra) => (
                <TableRow key={compra.CompraId}>
                  ...
                  <TableCell align="left">{compra.Productoid}</TableCell>
              ...
              <TableRow>
                <TableCell colSpan={9} align="center">No hay compras disponibles</TableCell>
              </TableRow>
            )}
          </TableBody>
        </Table>
